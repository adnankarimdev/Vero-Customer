...
export default function ThankYouPage() {
    ...
    useEffect(() => {
      ...
      }, 2500); // Show emoji after the first text types
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-white space-y-4">
        <div className="flex items-center">
          <TypingEffect text="Wow, that was fast. You’re a feedback superstar!" speed={50} />
          {showFirstEmoji && <span className="text-4xl ml-2">🏃💨</span>}
        </div>
        
        {showSecondComponent && (
          <div className="flex items-center">
            <TypingEffect text="Thanks for using Vero" speed={50} className="text-md text-muted-foreground"/>
