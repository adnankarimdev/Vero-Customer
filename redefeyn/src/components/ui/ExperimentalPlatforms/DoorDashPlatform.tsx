    ...
    <Card className="w-full max-w-6xl border border-gray-200 bg-white shadow-md rounded-xl overflow-hidden">
      <CardHeader className="bg-[#FF3008] text-white p-6">
        ...
        <CardDescription className="text-center text-white/90 mt-2">
          {rating <= 4 ? "How was your meal?" : "We're thrilled you enjoyed your food! 🍽️"}
        </CardDescription>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/3 p-6 bg-gray-50 border-l border-gray-200">
          ...
          {allSelectedBadges.length > 0 ? (
                ...
                <div key={index} className="flex items-center justify-between bg-white p-2 rounded-lg shadow-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button
                      ...
                      onClick={() => {
                        const category = Object.keys(selectedBadges).find(cat => selectedBadges[cat].includes(badge));
            ...
            <p className="text-gray-500 italic">Your order is empty. Start adding items!</p>
          )}
        </div>
      </div>
      <CardFooter className="flex justify-between items-center border-t border-gray-200 p-4 bg-gray-50">
        ...
        <AlertDialog open={isAlertDialogOpen}>
          <AlertDialogContent className="bg-white">
            <AlertDialogHeader>
              <AlertDialogTitle className="text-2xl font-bold text-gray-800">Thanks for your order! 🍽️</AlertDialogTitle>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={handleGenerateReview} className="bg-[#FF3008] text-white hover:bg-[#E62B07]">
                Yes, share review!
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
