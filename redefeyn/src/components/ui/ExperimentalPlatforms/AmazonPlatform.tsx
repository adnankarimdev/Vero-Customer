    ...
    <Card className="w-full max-w-6xl border border-gray-200 bg-white shadow-md rounded-xl overflow-hidden">
      <CardHeader className="bg-gradient-to-r from-[#232F3E] to-[#37475A] text-white p-6">
        ...
        <CardDescription className="text-center text-white/90 mt-2">
          {rating <= 4 ? "How was your shopping experience?" : "We're thrilled you enjoyed shopping with us! 🛍️"}
        </CardDescription>
      ...
      <CardFooter className="flex justify-between items-center border-t border-gray-200 p-4 bg-[#F3F3F3]">
        ...
        <AlertDialog open={isAlertDialogOpen}>
          <AlertDialogContent className="bg-white">
            <AlertDialogHeader>
              <AlertDialogTitle className="text-2xl font-bold text-[#232F3E]">Thanks for your purchase! 🛍️</AlertDialogTitle>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={handleGenerateReview} className="bg-[#FF9900] text-white hover:bg-[#FFAC31]">
                Yes, share review!
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
